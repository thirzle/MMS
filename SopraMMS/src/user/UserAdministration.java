...
public class UserAdministration {
	...
	public void sendNewPasswordLink(String email) throws IOException {
		...
		text.append("Sehr geehrte/geehrter Frau/Herr " + user.getLastName()
				+ ",");
		text.append("\n\n");
		text.append("Sie haben soeben ein neues Passwort f�r Ihren Account (Benutzername: "
	...
	public void sendNewPasswordLinkForNewUser(User user) throws IOException {
		...
		text.append("Sehr geehrte/geehrter Frau/Herr " + user.getLastName()
				+ ",");
		text.append("\n\n");
		text.append("Sie wurden soeben an dem Modul Management System der Universit�t Ulm registriert.");
		text.append("\n\n");
		text.append("Der Benutzername f�r Ihren registrierten Account lautet: "+user.getLogin());
		text.append("\n\n");
		text.append("Bitte rufen Sie folgenden Link auf und erstellen Sie ihr Passwort.");
		text.append("\n\n");
		text.append(url);
		text.append("\n\n");
		text.append("Sie haben die M�glichkeit das neu erstellte Passwort zu einem sp�teren Zeitpunkt zu �ndern.");
		text.append("\n\n");
		text.append("Mit freundlichen Gr��en");
		text.append("\n");
		text.append("MMS-Team");
...
//	get Mail: �bergeben: Liste von Rechten, gibt zur�ck: Liste mit String Array -->Name, Vorname, Email-Adresse
	/**
