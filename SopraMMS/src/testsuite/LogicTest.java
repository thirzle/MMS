...
public class LogicTest {
	...
	private static void module_load_test(){	
		...
		for(int i = 0; i < modules.size(); i++){
			...
			System.out.println("# Modification Date: " + m.getModificationDate());
			if(m.isApproved()){
	...
	private static void module_creation_test(){		
		...
		Module test_module = new Module(1337, "test_module", new Date(), new Date(),
				false, "Institut007");
		
		//version, timestamp, classification, approved, rejected, title, text
		TextualEntry test_textualentry = new TextualEntry(42, "02:44:35", false, false, false,
				"TextualEntryTitle: ", "some strange text for test purposes...");
		...
		//version, timestamp, classification, approved, rejected, title, presenceTime, selfstudyList
		EffortEntry test_effortentry = new EffortEntry(43, "02:44:36", false, false, false,
				"EffortEntryTitle: ", 2, selfstudylist);
		
		//version, timestamp, classification, approved, rejected, title, course
		CourseEntry test_courseentry = new CourseEntry(44, "02:44:37", false, false, false,
				"CourseEntryTitle: ", "Couse 08-15");
		...
		try {
			pdfcreator.createModulePdf("C:/PDFBox_test/module.pdf", test_module);
