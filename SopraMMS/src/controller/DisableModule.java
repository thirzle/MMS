			...
			if (request.getParameter("action") == null) {
				...
				if (request.getParameter("action").equals("disable")) {
					...
					String infotext = "Das Modul '"
							+ module.getName()
							+ "' wurde zur�ckgesetzt und muss erst wieder feigegeben werden um in einem neuen Modulhandbuch aufzutauchen.";
					response.sendRedirect("/SopraMMS/guiElements/home.jsp?home=true&infotext="
							+ infotext);
				} else if (request.getParameter("action").equals("ok")) {
					String infotext = "Das Modul '"
							+ module.getName()
							+ "' wurde akzeptieren und wird im neuen Modulhandbuch ver�ffentlicht.";
					response.sendRedirect("/SopraMMS/guiElements/home.jsp?home=true&infotext="
							+ infotext);
				}
			}
